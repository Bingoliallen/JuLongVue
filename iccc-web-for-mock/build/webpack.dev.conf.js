...
module.exports = new Promise((resolve, reject) => {
  ...
  portfinder.getPort((err, port) => {
    if (err) {
      ...
      if (fs.existsSync('node_modules/ui-jz-v4-common/package.json')) {
        commonPackageJson = require('ui-jz-v4-common/package');
      }
      if (commonPackageJson && commonPackageJson.version) {
        messages.push(`   ui-jz-v4-common's version is ${commonPackageJson.version}`);
      }
