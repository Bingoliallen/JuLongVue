...
<script>
    ...
    import { Debounce, LoadEvent } from "./utils.js";
    ...
    export default {
        ...
        computed: {
            mixedConfig() {
                this.changeContext();
                return Object.assign({}, config, this.defaultConfig, this.config);
            }
        },
        methods: {
            changeContext(){
                let serverContext = this.config.serverContext || getSetting("BASE_API");
                if (this.config.serverContext === "") {
                    serverContext = this.config.serverContext;
                }
                this.config.imageUrlPrefix = serverContext;
                this.config.scrawlUrlPrefix = serverContext;
                this.config.snapscreenUrlPrefix = serverContext;
                this.config.catcherUrlPrefix = serverContext;
                this.config.videoUrlPrefix = serverContext;
                this.config.imageManagerUrlPrefix = serverContext;
                this.config.fileManagerUrlPrefix = serverContext;
                this.config.fileUrlPrefix = serverContext;
            },
            ...
            _initEditor() {
                ...
                // 先保留，后覆盖详情请看 UEditor config.json文件
                window.UE.Editor.prototype._bkGetActionUrl = window.UE.Editor.prototype.getActionUrl;
                if(this.config.getActionUrl){
                    window.UE.Editor.prototype.getActionUrl = this.config.getActionUrl
                }else{
                    window.UE.Editor.prototype.getActionUrl = function(type) {
                        if (type === "uploadscrawl") {
                            return `${getSetting("BASE_API")}/api/encodedfile/upload`;
                        } else {
