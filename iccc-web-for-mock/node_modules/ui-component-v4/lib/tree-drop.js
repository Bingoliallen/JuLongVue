...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/tree-drop/src/option.vue"
...
var pinyin = __webpack_require__(42);
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
        ...
        value: {
            ...
            handler: function handler(val) {
                ...
                this.$nextTick(function () {
                    ...
                    _this2.selectVal = Object(data_convert["a" /* data2type */])(selectFilterValue, 'String', _this2.seq);

                    var filterValue = _this2.translateValueToTags(val, _this2.valueType);
                    var formatValue = Object(data_convert["a" /* data2type */])(filterValue, 'String', _this2.seq);
    ...
    computed: {
        ...
        treeBind: function treeBind() {
            var treeBind = Object(merge["a" /* default */])({}, this.treeProps, {
                data: this.dataSource,
                props: this.alias,
    ...
    methods: _extends({
        ...
        translateValueToTags: function translateValueToTags(value, type) {
            ...
            // 验证值是否为空，是否为空数组，为全类型
            if (typeof value === 'string' && !value || (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && value.length === 0) {
                return value;
            }
            // || type === 'all'
            // 若是多选情况
...
/* hot reload */
if (false) { var main_api; }
main_component.options.__file = "packages/tree-drop/src/main.vue"
/* harmony default export */ var main = (main_component.exports);
...
/* harmony default export */ var tree_drop = __webpack_exports__["default"] = (main);
