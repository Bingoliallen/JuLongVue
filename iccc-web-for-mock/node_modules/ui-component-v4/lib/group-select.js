...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/group-select/src/option.vue"
...
var pinyin = __webpack_require__(43);
                ...
                if (item.isParentNode) {
                    ...
                    fromNodes.map(function (fromNode) {
                        if (ids.indexOf(fromNode.id) < 0) {
                            item.children.push(_extends({}, fromNode, {
...
var transfer_tree_component = Object(componentNormalizer["a" /* default */])(
...
transfer_tree_component.options.__file = "packages/group-select/src/transfer-tree.vue"
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
    ...
    computed: {
        ...
        innerGroupData: function innerGroupData() {
            ...
            return dataSource.map(function (item) {
                ...
                return mainvue_type_script_lang_js_extends({}, item, { disabled: false, originDisabled: item.disabled });
            });
        },
        ...
        val: {
            ...
            get: function get() {
                ...
                return Object(data_convert["a" /* data2type */])(filterValue, 'String', this.seq);
            },
    ...
    methods: mainvue_type_script_lang_js_extends({
        ...
        _mergeTreeProps: function _mergeTreeProps(props) {
            return Object(merge["a" /* default */])({}, props, {
                data: this.dataSource,
                props: this.alias,
        ...
        setTreeOrSelectData: function setTreeOrSelectData(val) {
            ...
            var a = Object(data_convert["a" /* data2type */])(val, outputFormat, seq);
        ...
        _handleCheckChange: function _handleCheckChange(data, checked, indeterminate, ref) {
            ...
            this.debounceHandler = setTimeout(function () {
                var resultKeys = Object(data_convert["a" /* data2type */])(_data, outputFormat, _seq);
                var type = typeof resultKeys === 'undefined' ? 'undefined' : _typeof(resultKeys);
                if (type === "string") {
        ...
        syncSelectBoxValue: function syncSelectBoxValue() {
            ...
            var value = Object(data_convert["a" /* data2type */])(this.value, 'String', seq);
...
/* hot reload */
if (false) { var main_api; }
main_component.options.__file = "packages/group-select/src/main.vue"
/* harmony default export */ var main = (main_component.exports);
...
/* harmony default export */ var group_select = __webpack_exports__["default"] = (main);
