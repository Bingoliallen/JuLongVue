...
export default class Node {
    ...
    setData(data) {
        ...
        // create-start author:lutz
        // check-leaf 只能选择子节点
        const { checkLeaf, props } = this.store;
        ...
        if (this.level === 0 && this.data instanceof Array) {
            ...
            // create-start author:lutz
            const { checkStrictly, props } = this.store;
            const disabled = getPropertyFromData(this, 'disabled');
            const disabledName = props.disabled;
            ...
            if (!recursion) {
                ...
                if (this.expanded) {
                    ...
                    if (this.isLeaf) {
                        ...
                        const { all } = getChildState(this.childNodes);
                        newValue = all;
                    }
                            ...
                            const handleDescendants = () => {
                                if (deep) {
                                    ...
                                    for (let i = 0, j = childNodes.length; i < j; i++) {
                                        ...
                                        passValue = passValue || this.checked !== false;
