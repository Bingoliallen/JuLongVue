<template>
    <div class="el-calendar dg-calendar">
        <div class="el-calendar__header">
            <!-- edit by author: tangdm descript: add the slot for header -->
        ...
        <!-- add by author: tangdm descript: add the slot for footer -->
        <div class="el-calendar__footer">
...
import fecha from 'main/utils/date';
import { ElButton, ElButtonGroup } from 'element-ui';
import DateTable from './date-table';
import { validateRangeInOneMonth } from 'main/utils/date-util';
