    ...
    callback(
        [
            ...
            '<div class="' +
                ...
                (function() {
                    var closebtn = ismax
                        ? '<a class="layui-layer-min" href="javascript:;"><cite></cite></a><a class="layui-layer-ico layui-layer-max dg-icon-fullscreen" href="javascript:;"></a>'
                        : '';
                    config.closeBtn &&
                        (closebtn +=
                            '<a class="layui-layer-ico el-icon-close ' +
                            doms[7] +
                            ' ' +
                            doms[7] +
...
ready.record = function(layero) {
    ...
    layero
        ...
        .removeClass('dg-icon-fullscreen')
        .addClass('dg-icon-scalescreen');
...
layer.min = function(index, options) {
    ...
    layero
        .find('.layui-layer-max')
        .removeClass('dg-icon-scalescreen')
        .addClass('dg-icon-fullscreen');
};
